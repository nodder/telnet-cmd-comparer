...
set BeyondCompare_dir=D:\Tools\BeyondCompare3\

set JAVA=%JAVA_HOME%\bin\java
set MAIN_LIB=.\lib
set classpath=%JAVA_HOME%\lib\dt.jar;%JAVA_HOME%2\lib\tools.jar;%MAIN_LIB%\cdd-telnet-cmd-compare.jar;%MAIN_LIB%\jta20.jar;
